...
<div class="row  justify-content-center"  id="affichestage" >
    ...
    <form style="background-color:#d2eeee;padding: 10%; margin-top:5%;" method="post" action="<?php echo e(url('/formation')); ?>" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="exampleFormControlInput1" name="ville" placeholder="La ville où situe la formation" value="<?php echo e(old('ville')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="01f" placeholder="Dscription de formation" name="description" rows="7" value="<?php echo e(old('description')); ?>" required></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <div class="custom-file form-group">
                    <input type="file" class="custom-file-input" name="file" value="<?php echo e(old('file')); ?>" id="validatedCustomFile" >
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\S6\pfenew\app\smi_fsa\resources\views/experience/ajoutformation.blade.php ENDPATH**/ ?>