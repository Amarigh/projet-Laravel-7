...
<br>
<?php if($a->durer): ?>
<span class="badge badge-danger badge-pill">durer de stage <?php echo e($a->durer); ?></span>
<?php endif; ?>
<?php if($a->entreprise): ?>
<span class="badge badge-success badge-pill"><?php echo e($a->entreprise); ?></span>
<?php endif; ?>
<?php if($a->ville): ?>
...
<li class="list-group-item d-flex justify-content-between align-items-center active">
    <p>Pas des stages maintenant  </p>  
    <span class="badge badge-secondary badge-pill">pill1</span>
</li>
<?php endif; ?>

<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\S6\pfenew\app\smi_fsa\resources\views/experience/stage.blade.php ENDPATH**/ ?>